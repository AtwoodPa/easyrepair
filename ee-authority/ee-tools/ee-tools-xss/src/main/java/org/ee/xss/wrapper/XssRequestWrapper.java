package org.ee.xss.wrapper;

import lombok.extern.slf4j.Slf4j;
import org.ee.xss.utils.XssUtils;
...
public class XssRequestWrapper extends HttpServletRequestWrapper {
    ...
    public String[] getParameterValues(String paramString) {
        ...
        for (int j = 0; j < i; j++) {
//            System.out.println("Antisamy过滤清理，清理之前的参数值：" + arrayOfString1[j]);
            arrayOfString2[j] = XssUtils.xssClean(arrayOfString1[j], this.ignoreParamValueList);
//            System.out.println("Antisamy过滤清理，清理之后的参数值：" + arrayOfString2[j]);
        }
